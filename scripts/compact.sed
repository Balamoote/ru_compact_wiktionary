...
#/^\{"word":"позакрываться"/ s/^(\{"word":")позакрываться(","pos":"verb","forms":\[\{"form":"позакры́ться")/\1позакрыться\2/g
 ...
 /^\{"word":"поулечь"/ s/"поуле́чгл/"поуле́гл/g;
 /^\{"word":"разнемочься"/ { s/"разнемо́ла́сь"/"разнемогла́сь"/g; s/"разнемо́г"/"разнемо́гся"/g; }
 /^\{"word":"африканизировать"/ { s/("африканизи́ро)([влт])([^"]+")?/\1ва\2\3/g; s/"африканизи́ранный"/"африканизи́рованный"/g; }
 /^\{"word":"узриться"/ s/"узру́сь"/"узрю́сь"/g;
 /^\{"word":"четырёхъядерник"/ s/"четырёъхя́дерник/"четырёхъя́дерник/g;
 /^\{"word":"девочка-девочка"/ {s/"дѐвочкою-де́вочкоюдѐвочками-"/"де́вочками-де́вочками"/g;s/"де́вочкамидѐвочке-"/"де́вочке-де́вочке"/g;s/"де́вочкедѐвочках-"/"де́вочках-де́вочках"/g;}
 /^\{"word":"консуммация"/ s/"консумма́ц/"консума́ц/g;
 /^\{"word":"литтератор"/ s/"литтера́тор/"литера́тор/g;
 /^\{"word":"литтература"/ s/"литтер/"литер/g;
 /^\{"word":"литтературный"/ s/"литтер/"литер/g;
 /^\{"word":"перстень-печатка"/ s/("пе́рст)([^-]+-)[^\}]+\},\{"form":"(печа́т)/\1\2\3/g;
 /^\{"word":"транс-изомер"/ s/нс-из/нcиз/g;
 /^\{"word":"укат"/ s/"ука́ти"/"ука́ты"/g;
 /^\{"word":"одноплëкий"/ s/ë/ё/g;
 /^\{"word":"бело-красно-синий"/ s/\{"form":"бѐло-кра̀сно-си́нь","tags":\["singular","masculine","short-form"\]\},//g;
 /^\{"word":"вишнёво-синий"/ s/\{"form":"вишнё̀во-си́нь","tags":\["singular","masculine","short-form"\]\},//g;
 /^\{"word":"светло-синий"/ s/\{"form":"свѐтло-си́нь","tags":\["singular","masculine","short-form"\]\},//g;
 /^\{"word":"серо-синий"/ s/\{"form":"сѐро-си́нь","tags":\["singular","masculine","short-form"\]\},//g;
 /^\{"word":"тёмно-синий"/ s/\{"form":"тё̀мно-си́нь","tags":\["singular","masculine","short-form"\]\},//g;
 /^\{"word":"синий"/ s/\{"form":"синь","tags":\["singular","masculine","short-form"\]\},//g;
 /^\{"word":"подтяёжно-лесостепной"/ s/подтяёжно/подтаёжно/g;
 /^\{"word":"переписной"/ s/писать/писн/g;
 /^\{"word":"общезаводской"/ s/"о̀бщезаводскы́/"о̀бщезаводски́/g;
 /^\{"word":"благоприобретённый"/ s/"благоприобретённ"/"благоприобретён"/g;
 /^\{"word":"всенепременный"/ s/"всенепреме́нн"/"всенепреме́нен"/g;
 /^\{"word":"двадцатидевятилетний"/ s/"двадцатѝдевятиле́тнь"/"двадцатѝдевятиле́тен"/g;
 /^\{"word":"колочный"/ s/(,\{"form":")ко́-лоч-ный(","tags":\["comparative"),"infinitive"(\]\})/\1ко́лочнее\2\3\1ко́лочней\2\3/g;
 /^\{"word":"хороший"/ s/,\{"form":"образуются супплетивно","tags":\["comparative"\]\}//g;
 /^\{"word":"одиннадцатый"/ s/,\{"form":"одиннадцать","tags":\["perfective"\]\}//g;
 /^\{"word":"двухобщинный"/ s/"двухобщи́нн"/"двухобщи́нен"/g;
 /^\{"word":"двухолмный"/ s/"двухо́лмн"/"двухо́лмен"/g;
 /^\{"word":"игрений"/ s/"игре́нь"/"игре́нен"/g;
 /^\{"word":"негазифицированный"/ s/"негазифици́рованен"/"негазифици́рован"/g;
 /^\{"word":"неубиенный"/ s/"неубие́нн"/"неубие́нен"/g;
 /^\{"word":"неяркий"/ { s/"нея́рк"/"нея́рок"/g; s/"нея́рока́"/"неярка́"/g;}
 /^\{"word":"предмобилизационный"/ s/"предмобилизацио́нн"/"предмобилизацио́нен"/g;
 /^\{"word":"сатиетогенный"/ s/"сатиетоге́нн"/"сатиетоге́нен"/g;
 /^\{"word":"зарисовывать"/ s/,\{"form":"зарисовывайнный","tags":\["passive","past"\]\}//g;
 /^\{"word":"пережидать"/ s/,\{"form":"пережида́йнный","tags":\["passive","past"\]\}//g;
 /^\{"word":"катетеризовать"/ s/"катетеризо́ваанный"/"катетеризо́ванный"/g;
 /^\{"word":"параметризовать"/ s/"параметризоваанный"/"параметризованный"/g;
 /^\{"word":"переносить"/ s/"перено́шнный"/"перено́шенный"/g;
 /^\{"word":"подмывать"/ s/,\{"form":"подмывайнный","tags":\["passive","past"\]\}//g;
 /^\{"word":"противоставлять"/ s/,\{"form":"противоставля́нный","tags":\["passive","past"\]\}//g;
 /^\{"word":"уратовать"/ s/"урато́нный"/"урато́ванный"/g;
 /^\{"word":"двадцатиоднолетний"/ s/"двадцатѝодноле́тнь"/"двадцатѝодноле́тен"/g;
 /^\{"word":"двухаршинный"/ s/"двухарши́нн"/"двухарши́нен"/g;
 /^\{"word":"обосноваться"/ s/"обоснуё/"обосну́е/g;
 /^\{"word":"разнобой"/ s/"разнобоёв"/"разнобо́ев"/g;
 /^\{"word":"твердонёбый"/ s/"твердонёеб"/"твердонёб"/g;
 /^\{"word":"рухавка"/ s/"ру́хавк"/"ру́хавок"/g;
 /^\{"word":"секвентема"/ s/"(секвенте́м)а([аеыуо])/"\1\2/g;
 /^\{"word":"прикрепить"/ { s/"прикрепённый"/"прикреплённый"/g; s/"прикре́пенный"/"прикре́пленный"/g; }
 /^\{"word":"автаркичный"/ s/"автарки́чн"/"автарки́чен"/g;
 /^\{"word":"апробационный"/ s/"апробацио́нн"/"апробацио́нен"/g;
 /^\{"word":"безразмерный"/ s/"безразме́рн"/"безразме́рен"/g;
 /^\{"word":"воротниковый"/ s/"воротнико́ев"/"воротнико́в"/g;
 /^\{"word":"затыловочный"/ { s/"затыло́вочен/"затыло́вочн/g; s/"затыло́вочн"/"затыло́вочен"/g; }
 /^\{"word":"интегразный"/ s/"интегра́зн"/"интегра́зен"/g;
 /^\{"word":"межфирменный"/ s/"межфи́рменн"/"межфи́рменен"/g;
 /^\{"word":"мускулатурный"/ s/"мускулату́рн"/"мускулату́рен"/g;
 /^\{"word":"негомогенный"/ s/"негомоге́нн"/"негомоге́нен"/g;
 /^\{"word":"несчётный"/ s/"несчётн"/"несчётен"/g;
 /^\{"word":"олигосахаридный"/ s/"о̀лигосахари́дн"/"о̀лигосахари́ден"/g;
 /^\{"word":"плоскодонный"/ s/"плоскодо́нн"/"плоскодо́нен"/g;
 /^\{"word":"плюригландулярный"/ s/"плюригландуля́рн"/"плюригландуля́рен"/g;
 /^\{"word":"статейный"/ s/"стате́йн"/"стате́ен"/g;
 /^\{"word":"сцинтилляционный"/ s/"сцинтилляцио́нн"/"сцинтилляцио́нен"/g;
 /^\{"word":"толстокишечный"/ s/"то̀лстокише́чн"/"то̀лстокише́чен"/g;
 /^\{"word":"триплоидный"/ s/"трипло́идн"/"трипло́иден"/g;
 /^\{"word":"эктогенный"/ s/"эктоге́ннн"/"эктоге́нен"/g;
 /^\{"word":"бурлескный"/ s/"бурле́скн"/"бурле́скен"/g;
 /^\{"word":"бурсацкий"/ s/"бурса́цк"/"бурле́скен"/g;
 /^\{"word":"Быков"/ { s/"(Бы́ков)а([мх]и?)"/"\1ы\2"/g; s/"Бы́ковом"/"Бы́ковом"/g;}
 /^\{"word":"Жуков"/ { s/"Жу́ковам"/"Жу́ковым"/g; s/"Жу́ковами"/"Жу́ковыми"/g; s/"Жу́ковах"/"Жу́ковых"/g;};
 /^\{"word":"Дамаскин"/ {s/"Дамаскины́м"/"Дамаски́ном"/g;s/"Дамаскины́ми"/"Дамаски́нами"/g;s/"Дамаскины́х"/"Дамаски́нах"/g;s/"(Дамаски)(н.)\xcc\x81([^"]*)"/"\1\xcc\x81\2\3"/g;}
 /^\{"word":"Тауматауакатангиангакоауауотаматеатурипукакапикимаунгахоронукупокануэнуакитанатаху"/d;
 /^\{"word":"Саламанка"/ s/"Салама́нк"/"Салама́нок"/g;
 /^\{"word":"Хованский"/ { s/"Хова́нскии"/"Хова́нские"/g; s/"Хова́нския"/"Хова́нского"/g; s/"Хова́нскию"/"Хова́нскому"/g; s/"Хова́нскиев"/"Хова́нских"/g;
                           s/"Хова́нскием"/"Хова́нским"/g; s/"(Хова́нски)я([^"]+)"/"\1\2"/g;};
 /^\{"word":"привенериться"/ s/"привене́рй/"привене́рь/g;
 /^\{"word":"проворотить"/ s/"провороти́[ейю]/"провороти́/g;
 /^\{"word":"ворсильный"/ s/"ворси́лtн"/"ворси́лен"/g;
 /^\{"word":"странничек"/ s/"(стра́ннич)е(к[аеиоу])/"\1\2/g;
 /^\{"word":"бурсацкий"/ s/,\{"form":"бурса́цк","tags":\["singular","masculine","short-form","error"\]\}//g;
 /^\{"word":"вольтеровский"/ s/,\{"form":"вольте́ровска?","tags":\["singular","masculine","short-form","error"\]\}//g;
 /^\{"word":"хвост"/ s/,\{"form":"устар","tags":\["masculine"\],"raw_tags":\["падеж"\]\}//g;
 /^\{"word":"хор"/ s/,\{"form":"устар","tags":\["masculine"\],"raw_tags":\["падеж"\]\}//g;
 /^\{"word":"щит"/ s/,\{"form":"устар","tags":\["masculine"\],"raw_tags":\["падеж"\]\}//g;
 /^\{"word":"полоз"/ s/,\{"form":"разг","tags":\["masculine"\],"raw_tags":\["падеж"\]\}//g;
 /^\{"word":"ил"/ s/,\{"form":"редк","tags":\["masculine"\],"raw_tags":\["падеж"\]\}//g;
 /^\{"word":"чин"/ s/,\{"form":"редк","tags":\["masculine"\],"raw_tags":\["падеж"\]\}//g;
 /^\{"word":"винтертурский"/ s/"вин-тер-ту́р-ский"/"винтерту́рский"/g;
 /^\{"word":"колочный"/ { s/"ко́-лоч-ный"/"ко́лочный"/g; s/"ко-ло́ч-ный"/"коло́чный"/g; }
 /^\{"word":"дид"/ s/"детск"/"ди́да"/g;
 /^\{"word":"дед"/ s/"детск"/"де́да"/g;
 /^\{"word":"сын"/ { s/"прост"/"сы́на"/g; s/(,\{"form":")устар(","tags":\["vocative"\],"raw_tags":\["падеж"\]\},)/\1сы́не\2/g;
                     s/(,\{"form":")устар(","tags":\["vocative"\],"raw_tags":\["падеж"\]\}\])/\1сы́ну\2/g; }
